...
public class UTM {
    ...
    private static void populateRegion(List<String> values, String startLetter, String endLetter, int start, int end) {
        ...
        List<String> prefix = UTMConvert.latValues.subList(UTMConvert.latValues.indexOf(startLetter), UTMConvert.latValues.indexOf(endLetter) + 1);
    ...
    public static void createUTMRegions() {
        ...
        for (String val : UTMConvert.latValues) {
            for (int i = 1; i <= 60; i++) {
