...
public class MessageTest {
    ...
    public static final String GAME_OBJECT = "{" + Tags.GAME_OBJECT + " :{" + Tags.GAME_OBJECT_KEY + ":'58',"+Tags.GAME_OBJECT_TYPE+":1, "+Tags.GAME_OBJECT_SUBTYPE+":1," + Tags.STATE + ":" + Tags.GAME_OBJECT_HIT + "," + Tags.VALUE + ":'true'," + Tags.GAME_OBJECT_MASS + ":2098," + Tags.GAME_OBJECT_ACCELERATION + ":9.99," +
